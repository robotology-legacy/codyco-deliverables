...
\item[WP2/WP3] JSI and UPMC have explored experimentally and using a computational model the curved movement trajectories observed on diagonal reaching movement.
\end{itemize}
