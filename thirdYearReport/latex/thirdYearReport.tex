...
\begin{figure}[h]
  \centering
    \includegraphics[width=.6\textwidth]{images/icub_igt_2.jpeg}
...
\noindent
\fbox{\begin{minipage}{\textwidth}
\emph{The simulation environment and experimental data are in open source, and this is commendable, but they should be made more easy to use.} \end{minipage}}
