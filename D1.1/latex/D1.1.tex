...
\deliverableContributors{Sovannara Hak, Serena Ivaldi, Mingxing Liu, Vincent Padois (UPMC) / Andrea Del Prete, Francesco Nori, Daniele Pucci, Francesco Romano, Silvio Traversao (IIT) / Leon \v{Z}lajpah (JSI)}
