...
\begin{figure}
	\centering
	\includegraphics[width=.3\textwidth]{twoellipses1.pdf}
 	\includegraphics[width=.315\textwidth]{twoellipses2.pdf}
...
\begin{figure*}
	\centering
	\includegraphics[width=0.4\linewidth]{"methods"}
...
\begin{figure*}
	\centering
	\includegraphics[width=0.4\textwidth]{"step error-all steps"}
...
\begin{figure*}
	\centering
	\includegraphics[width=0.4\textwidth]{"step onset time-all steps"}
...
\begin{figure*}
	\centering
	\includegraphics[width=0.4\textwidth]{"step exec time-all steps"}
...
\begin{figure*}
	\centering
	\includegraphics[width=0.4\textwidth]{"SD1"}
...
\begin{figure*}
	\centering
	\includegraphics[width=0.4\textwidth]{"range1"}
