...
\begin{figure*}[!ht]
	\centering
	\includegraphics[width=0.6\linewidth]{"methods"}
...
\begin{figure*}[!ht]
	\centering
	\includegraphics[width=0.6\textwidth]{"step error-all steps"}
...
\begin{figure*}[!ht]
	\centering
	\includegraphics[width=0.6\textwidth]{"step onset time-all steps"}
...
\begin{figure*}[!ht]
	\centering
	\includegraphics[width=0.6\textwidth]{"step exec time-all steps"}
...
\begin{figure*}[!ht]
	\centering
	\includegraphics[width=0.7\textwidth]{"SD1"}
...
\begin{figure*}[!ht]
	\centering
	\includegraphics[width=0.7\textwidth]{"range1"}
